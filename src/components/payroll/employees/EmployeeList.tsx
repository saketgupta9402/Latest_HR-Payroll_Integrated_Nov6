...
import { ManageCompensationDialog } from "@/components/payroll/employees/ManageCompensationDialog";
...
export const EmployeeList = ({ searchTerm }: EmployeeListProps) => {
  const [selectedEmployee, setSelectedEmployee] = useState<{ id: string; name: string; joiningDate?: string } | null>(
    null,
  );
          ...
          <TableBody>
            {employees.map((employee: Employee) => (
              <TableRow key={employee.id}>
                ...
                <TableCell>{new Date(employee.date_of_joining).toLocaleDateString("en-IN")}</TableCell>
                <TableCell>
