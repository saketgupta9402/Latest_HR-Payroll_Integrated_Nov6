...
const PayrollSettingsPage = () => {
  ...
  const handleSave = async () => {
    const total =
      parseFloat(settings.basic_salary_percentage || "0") +
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <header className="border-b bg-card/50 backdrop-blur-sm sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4">
          <Button variant="ghost" onClick={() => navigate("/payroll/cycles")} className="mb-2">
          ...
          <Card className="shadow-md">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="pf_rate" type="number" step="0.01" value={settings.pf_rate} onChange={handleSettingChange} />
                <p className="text-xs text-muted-foreground">Standard PF rate is 12%</p>
              </div>

              <div className="space-y-2">
                <Label htmlFor="esi_rate">ESI Rate (%)</Label>
                <Input id="esi_rate" type="number" step="0.01" value={settings.esi_rate} onChange={handleSettingChange} />
                <p className="text-xs text-muted-foreground">Standard ESI rate is 3.25%</p>
              </div>

              <div className="space-y-2">
                <Label htmlFor="pt_rate">Professional Tax (₹)</Label>
                <Input id="pt_rate" type="number" step="0.01" value={settings.pt_rate} onChange={handleSettingChange} />
              ...
              <div className="space-y-2">
                ...
                <Input id="tds_threshold" type="number" step="0.01" value={settings.tds_threshold} onChange={handleSettingChange} />
          ...
          <Card className="shadow-md">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="hra_percentage" type="number" step="0.01" value={settings.hra_percentage} onChange={handleSettingChange} />
                ...
                {(() => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isInvalid ? <p className="mt-1">⚠️ Salary components must sum to exactly 100%</p> : <p className="mt-1">✓ All components sum to 100%</p>}
                    </div>
                  );
                })()}
              </div>
