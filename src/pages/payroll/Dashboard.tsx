        ...
        {recentCycles.length > 0 && (
          <Card className="mb-8 shadow-md">
            ...
            <CardContent>
                ...
                {recentCycles.map((cycle: any) => {
                  ...
                  return (
                    <div
                      ...
                      onClick={() => navigate("/payroll/cycles")}
                    >
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            {cycle.total_employees || 0} employees • ₹{(cycle.total_amount || 0).toLocaleString('en-IN')}
                          </p>
                        </div>
                      </div>
              ...
              <Button variant="outline" className="w-full mt-4" onClick={() => navigate("/payroll/cycles")}>
          ...
          >
            ...
            <CardContent>
              <Button
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  navigate("/payroll/employees?new=true");
                }}
              >
          ...
          >
            ...
            <CardContent>
              <Button
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  navigate("/payroll/cycles?new=true");
                }}
              >
                <PlusCircle className="mr-2 h-4 w-4" />
                New Payroll Cycle
