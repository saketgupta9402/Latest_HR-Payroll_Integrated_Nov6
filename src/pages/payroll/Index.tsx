    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/10 via-background to-accent/10">
      <section className="container mx-auto px-4 py-20 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button size="lg" onClick={() => navigate("/payroll/auth")} className="text-lg px-8">
            Get Started
          </Button>
          <Button size="lg" variant="outline" onClick={() => navigate("/payroll/auth")} className="text-lg px-8">
            Sign In
          </Button>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        ...
        <Button size="lg" onClick={() => navigate("/payroll/auth")} className="text-lg px-12">
          Start Free Trial
        </Button>
      </section>
    </div>
